...
const FOOD_IMAGES = {
  ...
  shawarma_house: {
    ...
    "تاكو ناشفل":      "https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/ME/chains/HS-ShawarmaHouse/nashville-taco.jpg",
...
const SAUDI_RESTAURANTS = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "تاكو ناشفل",     kcal: 620,  protein: 30, carbs: 38, fat: 35 },
